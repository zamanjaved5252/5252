...
<div id="pre-loader">
    <img src="/home/images/loader.gif" alt="Loading..." />
</div>
    	...
    	<div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                    <a href="index.html">
                    	<img src="home/images/logo.svg" alt="Belle Multipurpose Html Template" title="Belle Multipurpose Html Template" />
                    </a>
                </div>
                <!--End Desktop Logo-->
                            	...
                            	<div class="megamenu style4">
                                    <ul class="grid grid--uniform mmWrapper">
                                        ...
                                        <li class="grid__item lvl-1 col-md-6 col-lg-6">
                                        	<a href="#"><img src="home/images/megamenu-bg1.jpg" alt="" title="" /></a>
                                        </li>
                                    </ul>
                              	</div>
                            </li>
                        	...
                        	<div class="megamenu style2">
                                <ul class="grid mmWrapper">
                                    <li class="grid__item one-whole">
                                  	...
                                  	<li class="grid__item large-up--one-whole imageCol"><a href="#"><img src="home/images/megamenu-bg2.jpg" alt=""></a></li>
                                </ul>
                          	</div>
                        </li>
                ...
                <div class="col-4 col-sm-3 col-md-3 col-lg-2">
                	<div class="site-cart">
                        <div class="dropdown">
                            <a href="#;" class="site-header__cart" title="Cart"data-toggle="dropdown">
                        	...
                        	<ul class="mini-products-list">
                                ...
                                <li class="item">
                                	<a class="product-image" href="#">
                                    	<img src="home/images/product-images/cape-dress-1.jpg" alt="3/4 Sleeve Kimono Dress" title="" />
                                    </a>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="product-details-img">
                            <div class="pl-20">
                                <img src="home/images/product-detail-page/camelia-reversible-big1.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="swatch clearfix swatch-0 option1" data-option-index="0">
                                    <div class="product-form__item">
                                      ...
                                      <div data-value="Red" class="swatch-element color red available">
                                        ...
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-red" style="background-image:url(homehome/images/product-detail-page/variant1-1.jpg);" title="Red"></label>
                                      </div>
                                      <div data-value="Blue" class="swatch-element color blue available">
                                        <input class="swatchInput" id="swatch-0-blue" type="radio" name="option-0" value="Blue">
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-blue" style="background-image:url(homehome/images/product-detail-page/variant1-2.jpg);" title="Blue"></label>
                                      </div>
                                      <div data-value="Green" class="swatch-element color green available">
                                        <input class="swatchInput" id="swatch-0-green" type="radio" name="option-0" value="Green">
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-green" style="background-image:url(homehome/images/product-detail-page/variant1-3.jpg);" title="Green"></label>
                                      </div>
                                      <div data-value="Gray" class="swatch-element color gray available">
                                        <input class="swatchInput" id="swatch-0-gray" type="radio" name="option-0" value="Gray">
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-gray" style="background-image:url(homehome/images/product-detail-page/variant1-4.jpg);" title="Gray"></label>
                                      </div>
                                    </div>
                                </div>
	...
	<div class="newsletter-wrap" id="popup-container">
      <div id="popup-window">
        ...
        <div class="display-table splash-bg">
          <div class="display-table-cell width40"><img src="home/images/newsletter-img.jpg" alt="Join Our Mailing List" title="Join Our Mailing List" /> </div>
...
--}}
{{--
     <script src="/home/js/vendor/jquery-3.3.1.min.js"></script>
--}}{{--

     <script src="/home/js/vendor/modernizr-3.6.0.min.js"></script>
     <script src="/home/js/vendor/jquery.cookie.js"></script>
     <script src="/home/js/vendor/wow.min.js"></script>
     <!-- Including Javascript -->
     <script src="/home/js/bootstrap.min.js"></script>
     <script src="/home/js/plugins.js"></script>
     <script src="/home/js/popper.min.js"></script>
     <script src="/home/js/lazysizes.js"></script>
