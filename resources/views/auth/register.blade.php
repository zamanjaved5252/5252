        ...
        <div class="wrap-login100  p-b-30">
            ...
            <form action="{{ route('register') }}" method="post">
                ...
                <div class="wrap-input100 validate-input mb-2" data-validate = "Username is required">
                    <input class="input100 form-control {{ $errors->has('name') ? ' is-invalid' : ''}}" type="text" name="name" placeholder="Username">
                ...
                <div class="wrap-input100 validate-input mb-2" data-validate = "Username is required">
                    <input class="input100 {{ $errors->has('email') ? ' is-invalid' : ''}}" type="text" name="email" placeholder="enter your email">
                ...
                <div class="wrap-input100 validate-input mb-2" data-validate = "Password is required">
                    <input class="input100 form-control {{ $errors->has('password_confirmation') ? 'is-invalid' : ''}}" type="password" name="password_confirmation" placeholder="password_confirmation">
                    @if($errors->has('password_confirmation') || session()->has('alert'))
                        <span class="invalid-feedback" role="alert">
            ...
            <div class="container-login100-form-btn pt-2">
                <button class="login100-form-btn" onclick="window.location='{{ url("admin") }}'">
                    Login
                </button>
            </div>
